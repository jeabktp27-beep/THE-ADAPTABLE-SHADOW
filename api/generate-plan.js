...
1. วิเคราะห์เป้าหมายผู้ใช้อย่างเข้มงวด: หากเป้าหมายระบุส่วนใดส่วนหนึ่ง (เช่น "ขา") ให้ตัดท่าอื่นทิ้งทันทีโดยไม่มีข้อยกเว้น
2. ข้อมูลต้องเป็นประโยชน์สูงสุด: คำแนะนำ (message) และแรงบันดาลใจ (motivation) ต้องยาวไม่เกิน 1-2 ประโยค และต้อง "เกี่ยวข้องโดยตรง" กับเป้าหมายปัจจุบันเท่านั้น
3. กลไกกรองข้อมูล (Filtering Mechanism): 
   - ท่าที่เกี่ยวข้อง: ใส่ sets/reps ตามค่าที่กำหนด
   - ท่าที่ไม่เกี่ยวข้อง: ต้องตั้ง sets เป็น 0 และ reps เป็น 0 เสมอ
4. ห้ามตอบนอกเรื่อง: ห้ามมีบทสนทนาฟุ่มเฟือย ให้ตอบกลับเฉพาะ JSON ที่ถูกต้องตามโครงสร้างที่กำหนด` 
            },
