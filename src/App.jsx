    ...
    <div style={{ maxWidth: "480px", margin: "0 auto", padding: "40px 24px" }}>
      ...
      <div style={{ background: "#0d1a0d", border: "1px solid #00ff8822", borderRadius: "8px", padding: "32px" }}>
        ...
        <button
          ...
          style={{ width: "100%", marginTop: "8px", padding: "10px", background: "#ffd70011", border: "1px solid #ffd70033", borderRadius: "4px", cursor: "pointer", fontFamily: "'Space Mono',monospace", fontSize: "11px", color: "#ffd700", letterSpacing: "1px", transition: "all 0.2s" }}
          onMouseEnter={e => e.currentTarget.style.background = "#ffd70022"}
          onMouseLeave={e => e.currentTarget.style.background = "#ffd70011"}
        >
          🔍 ไม่ทราบค่าไขมัน — ประมาณจาก BMI ให้
        </button>
        ...
        <div style={{ borderBottom: "1px solid #00ff8811", padding: "16px 24px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
            ...
            {user ? (
              ...
              <button 
                onClick={handleLogin}
                style={{ background: "#00ff8822", border: "1px solid #00ff88", borderRadius: "4px", padding: "4px 8px", cursor: "pointer", fontFamily: "'Space Mono',monospace", fontSize: "10px", color: "#00ff88", transition: "all 0.2s" }}
              >
                CLOUD SYNC
              </button>
            )}
