  ...
  return (
    <div style={{minHeight:"100vh",background:"#060810",color:"#ffffff"}}>
      ...
      <div className="fade-in" key={page}>
        ...
        {page==="plan"&&plan&&<PagePlan plan={plan} onStart={ex=>{setExercise(ex);setCameraStream(null);setPage("camera-permission");}} onBack={()=>setPage("context")}/>}
        {page==="camera-permission"&&plan&&<PageCameraPermission exercise={exercise} plan={plan} onGranted={stream=>{setCameraStream(stream);setPage("tracker");}} onBack={()=>setPage("plan")}/>}
